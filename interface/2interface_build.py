...
min_thickness = 5.0
max_mismatch = 0.05
max_n = 8  # Limit supercell size to avoid overly large structures
...
# === Align LYC slab lattice direction ===
...
# === Find common supercell (consider a and b mismatch) ===
...
Poscar(final_structure).write_file("interfaces_output/POSCAR_Li_LYC.vasp")
...
print("✅ Li and LYC interface structure with 2D supercell matching and centering has been generated")
